...
//    init?(coder: NSCoder, viewModel: AuthNameViewModelProtocol) {
...
extension LastPeriodLongVC: UIPickerViewDelegate, UIPickerViewDataSource{
    ...
    func pickerView(_ pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int, reusing view: UIView?) -> UIView {
      ...
      //  pickerLabel.attributedText = NSAttributedString(string: pickerData[row], attributes: [NSAttributedString.Key.font:UIFont(name: "SourceSansPro-Bold", size: 26.0)!, NSAttributedString.Key.foregroundColor: UIColor.black])
